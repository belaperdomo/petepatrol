        ...
        while rclpy.ok():
            ...
            while True: #JV
                for event in c1.controller.read_loop():
                    ...
                    self.scaled_left_joystick = c1.linear_scaled_joystick('left',0,100)
                    ...
                    self.L2_scaled_value = c1.scaled_adaptive_trigger('L2',0,50,False)
                    self.R2_scaled_value = c1.scaled_adaptive_trigger('R2',0,50,False)
